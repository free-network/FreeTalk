...
#[component]
pub fn AddAdminModal(on_close: EventHandler<()>) -> Element {
    ...
    rsx! {
        div {
            ...
            div {
                ...
                div {
                    class: "p-6",
                    h1 { class: "text-xl font-semibold text-text mb-4", "Add Admin" }
                    ...
                    div { class: "bg-amber-500/20 border border-amber-500/50 rounded-lg p-4 mb-4",
                        div { class: "flex items-start gap-3",
                            ...
                            div {
                                p { class: "text-amber-200 font-semibold", "Admins cannot be removed" }
                    ...
                    if available_members.read().is_empty() {
                        ...
                        div { class: "mb-4",
                            ...
                            select {
                                class: "w-full bg-surface border border-border rounded-lg px-3 py-2 text-text focus:outline-none focus:ring-2 focus:ring-accent",
                                onchange: move |evt| {
